...
- **paper-lint**: As Karpathy suggests, occasionally tidying the wiki repository to avoid single-link chains, orphan pages, and broken links. We don't see this as a core focus, and it likely won't be used very frequently.
